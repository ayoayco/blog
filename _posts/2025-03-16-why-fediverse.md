---
title: "Why I Care So Much About the Fediverse"
permalink: /:title/
description: "Out of all the recent events, why do I care this much about this?"
category: technology
---
...
The [World Wide Web Consortium](https://www.w3.org/) has a set of [recommendations](https://www.w3.org/TR/social-web-protocols/) for this, which is now being taken care of by a [working group](https://www.w3.org/groups/wg/social/) and the [Social Web Foundation](https://socialwebfoundation.org/).
...
[Threads by Meta](https://engineering.fb.com/2024/03/21/networking-traffic/threads-has-entered-the-fediverse/) has joined. And even though Bluesky (which started as a research in Twitter) has their own proprietary protocol (AT Protocol), the devs are very supportive of [Bridgy Fed](https://fed.brid.gy/) -- a system for bridging interactions between the Fediverse's protocol and theirs.
...
Many institutions have put up their own communities now on the Fediverse, such as [Amsterdam](https://social.amsterdam.nl/about), [The European Union](https://ec.social-network.europa.eu/explore), and [various Academic institutions](https://github.com/nathanlesage/academics-on-mastodon).
